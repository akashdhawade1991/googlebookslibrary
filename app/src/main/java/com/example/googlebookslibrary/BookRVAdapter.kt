...
class BookRVAdapter(
    ...
    override fun onBindViewHolder(holder: BookRVAdapter.BookViewHolder, position: Int) {
        ...
        // Replace http with https in the thumbnail URL
        val secureThumbnail = bookInfo.thumbnail?.replace("http://", "https://")
        Picasso.get().load(secureThumbnail).into(holder.bookIV);
